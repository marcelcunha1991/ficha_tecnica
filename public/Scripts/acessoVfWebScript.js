                              ...
                              success: function(perifericos) {
                                 ...
                                 var camara = "<tr>" +
                                    ...
                                    var vapor = "<tr>" +
                                                   ...
                                                   "</td>" +
                                                   "<td colspan='1'>" +
                                                      "<p id='aguaF1Fixo'>Água Industrial F1</p>" +
                                                   "</td>" +
                                                   ...
                                                   "</td>" +
                                                   "<td colspan='1'>" +
                                                      "<p id='aguaF1Movel'>Água Industrial F1</p>" +
                                                   "</td>" +
                                                "</tr>" +
                                                "<tr>" +
                                                   "<td colspan='2'>" +
                                                   ...
                                                   "</td>" +
                                                   "<td colspan='1'>" +
                                                      "<p id='aguaF2Fixo'>Água Industrial F2</p>" +
                                                   "</td>" +
                                                   ...
                                                   "</td>" +
                                                   "<td colspan='1'>" +
                                                      "<p id='aguaF2Movel'>Água Industrial F2</p>" +
                                                   "</td>" +
                                                "</tr>" +
                                                "<tr>" +
                                                   "<td colspan='2'>" +
                                                   ...
                                                   "</td>" +
                                                   "<td colspan='1'>" +
                                                      "<p id='geladaMovel'>Água Gelada</p>" +
                                                   "</td>" +
                                                "</tr>" +
                                                "<tr>" +
                                                   "<td colspan='2'>" +
